...
List<GetPage> pages = [
  ...
  GetPage(name: Routes.signUpScreen,
      ...
      transitionDuration: const Duration(milliseconds: 0),
      page: () => SignupScreen()),
  GetPage(name: Routes.forgotScreen,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
  ...
  GetPage(name: Routes.otpScreen,
      ...
      transitionDuration: const Duration(milliseconds: 0),
      page: () => OtpScreen()),
  GetPage(name: Routes.otpForCreate,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => OtpForCreate()),
  GetPage(name: Routes.newPassScreen,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => NewpassScreen()),
  GetPage(name: Routes.mainScreen,
      ...
      transitionDuration: const Duration(milliseconds: 0),
      page: () => MainScreen()),
  GetPage(name: Routes.chartPage,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => ChartScreen()),
  GetPage(name: Routes.generateChartScreen,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => GenerateChart()),
  ...
  GetPage(name: Routes.changePass,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => ChangePass()),
  GetPage(
  ...
  GetPage(name: Routes.subscriptionPage,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => SubscriptionPage()),
  GetPage(name: Routes.paymentCard,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => PaymentCard()),
  GetPage(name: Routes.paymentType,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => PaymentType()),
  GetPage(name: Routes.reviewPage,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => ReviewGeneratePage()),
  GetPage(name: Routes.westernDetails,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => WesternDatails()),
  GetPage(name: Routes.mainDetailChart,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => MainDetailChart()),
  GetPage(name: Routes.personalInfo,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => PersonalInfo()),
  GetPage(name: Routes.personalInfoEdit,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => PersonalInfoEdit()),
  GetPage(name: Routes.astroData,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => AstroDataScreen()),
  GetPage(name: Routes.addAstroData,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => AddAstroDataScreen()),
  GetPage(name: Routes.singlePurchasePlan,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => SinglePurchasePlan()),
  GetPage(name: Routes.singleInfo,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => SingleInfo()),
  GetPage(name: Routes.singleReport,
      transition: Transition.noTransition,
      transitionDuration: const Duration(milliseconds: 0),
      page: () => SingleReport()),
];
