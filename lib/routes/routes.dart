...
import 'package:astrology_app/views/pages/profile/accounts/astro_data/add_astro_data.dart';
...
List<GetPage> pages = [
  GetPage(name: Routes.loginScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),page: () => LoginScreen()),
  GetPage(name: Routes.signUpScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => SignupScreen()),
  GetPage(name: Routes.forgotScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),page: () => ForgotpassScreen()),
  GetPage(name: Routes.otpScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),page: () => OtpScreen()),
  GetPage(name: Routes.otpForCreate,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),page: () => OtpForCreate()),
  GetPage(name: Routes.newPassScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => NewpassScreen()),
  GetPage(name: Routes.mainScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => MainScreen()),
  GetPage(name: Routes.chartPage,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => ChartScreen()),
  GetPage(name: Routes.generateChartScreen,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => GenerateChart()),
  GetPage(name: Routes.savedChart,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => SavedChartScreen()),
  GetPage(name: Routes.aiReading,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => AiReadingScreen()),
  GetPage(name: Routes.aiComprehensive,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => AiComprehensive()),
  GetPage(name: Routes.privacyPolicy,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),page: () => PrivacyPolicyScreen()),
  GetPage(name: Routes.changePass,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => ChangePass()),
  GetPage(name: Routes.natalChart,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => NatalChart(onNext:(){}),),
  GetPage(name: Routes.transitChart,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => TransitChart(onNext:(){}),),
  GetPage(name: Routes.synastryChart,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => SynastryChart(onNext:(){}),),
  GetPage(name: Routes.chartType,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => ChartTypeTab(onNext:(){}),),
  GetPage(name: Routes.subscriptionPage,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),page: () => SubscriptionPage()),
  GetPage(name: Routes.paymentCard,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => PaymentCard()),
  ...
  GetPage(name: Routes.addAstroData,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0),  page: () => AddAstroDataScreen()),
  GetPage(name: Routes.singlePurchasePlan,transition: Transition.noTransition, transitionDuration: const Duration(milliseconds: 0), page: () => SinglePurchasePlan()),
