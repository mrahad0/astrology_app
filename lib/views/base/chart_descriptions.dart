// chart_descriptions.dart
class ChartDescriptions {
  static const Map<String, String> descriptions = {
    ...
    'Galactic':
    'Galactic Astrology\n\nExpands beyond the 12 signs to include stars, galaxies, and cosmic points. Often connected to the concept of “starseeds” – the idea that some souls originated from other star systems like the Pleiades or Sirius, with the chart revealing clues about that origin.',
    'Human Design':
    'Human Design\n\nA system that blends astrology with other spiritual frameworks. It identifies your “type” and shows how you are best designed to make decisions and use your energy. Less about prediction, more about understanding how you naturally operate.',
  };
}
