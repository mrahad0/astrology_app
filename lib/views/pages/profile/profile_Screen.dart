        ...
        child: Column(
          ...
          children: [
           CustomSubscriptionContainer(),
            ...
            Text("Account", style: TextStyle(fontSize: ResponsiveHelper.fontSize(18),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          mainAxisAlignment: MainAxisAlignment.start,
          children: [
            SvgPicture.asset(url, width: ResponsiveHelper.iconSize(22), height: ResponsiveHelper.iconSize(22)),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child:  Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  SvgPicture.asset("assets/icons/crown-03.svg", width: ResponsiveHelper.iconSize(20), height: ResponsiveHelper.iconSize(20)),
                  SizedBox(width: ResponsiveHelper.space(10)),
                  Text(
                    "Manage Subscription",
                    style: TextStyle(
